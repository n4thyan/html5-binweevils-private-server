...
(function($) {
    ...
    $("img.img-hover").hover(
        function() {
            ...
            $(this).attr("src", $(this).data("img-over"));
        }, function() {
...
(function($) {
    ...
    $(".toggle-menu-img").toggle(
        function() {
            $(this).attr('src','/assets/img/binweevils/toggle-menu/close1.png');
            $(".toggle-menu").show('slow');
        },
        function() {
            $(this).attr('src','/assets/img/binweevils/toggle-menu/menu1.png');
...
function buyItemFromBlog(itemTypeID, storeName, colour, itemTypeIDfree, colourFree) {
    ...
    swal({
        ...
        function () {
            $.ajax({
                url: 'http://news.binweevils.com/ajax/buy-item-from-blog',
                method: "POST",
                data: {
                    ...
                    colour: colour,
                    timer: 1900624,
                    hash: "3d69729e0f78b16bc9def85f0253dd3f",
                    itemTypeIDfree: itemTypeIDfree || "",
                    colourFree: colourFree || ""
                },
                success: function (data) {
                    handleResponseCode(data, itemTypeID, storeName, colour, itemTypeIDfree, colourFree);
                }
            });
        });
...
function buyItemFromBlogWithVoucher(itemTypeID, storeName, colour, itemTypeIDfree, colourFree, useVoucher) {
    ...
    $.ajax({
        ...
        success: function (data) {
            handleResponseCode(data, itemTypeID, storeName, colour, itemTypeIDfree, colourFree, useVoucher);
        }
    });
}

function handleResponseCode(data, itemTypeID, storeName, colour, itemTypeIDfree, colourFree, useVoucher) {
    if (data.responseCode == 1) { //success
        swal({
            title: "Success!",
            text: "You have successfully purchased this item!</br> Check your My Stuff Box.",
            type: "success",
            html: true
        });
        return;
    }
    if (data.responseCode == 3) { //cannot afford
        swal({
            title: "Uh-oh!",
            text: "Sorry, you cannot afford this item.",
            type: "warning",
            html: true
        });
        return;
    }
    if (data.responseCode == 4) { //no item found
        swal({
            title: "Uh-oh!",
            text: "The item you are trying to purchase is not available.",
            type: "error",
            html: true,
            closeOnConfirm: true
        });
    ...
    if (data.responseCode == 7) { //tycoon only
        swal({
            title: "Uh-oh!",
            text: "Sorry, you need to be a Bin Tycoon Member</br> to purchase this item.",
            type: "error",
            html: true,
            closeOnConfirm: true
        });
    ...
    if (data.responseCode == 8) { //need higher level
        swal({
            title: "Uh-oh!",
            text: "Sorry, your level is not high enough to make this purchase.",
            type: "error",
            html: true,
            closeOnConfirm: true
        });
    ...
    if (data.responseCode == 9) { //not logged in
        haveToLogInToBuyItemFromBlog();
        return;
    }
    if (data.responseCode == 5) { //voucher is applicable and optional
        swal({
                title: "You have Dosh vouchers!",
                text: "You have earned <strong>"+data.voucher_dosh+" Dosh</strong> in vouchers!</br>Would you like to use it towards this purchase?",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#69b22c",
                confirmButtonText: "Yes",
                cancelButtonText: "No",
                closeOnConfirm: false,
                closeOnCancel: false,
            ...
            function(isConfirm){
                if (isConfirm) {
                    buyItemFromBlogWithVoucher(itemTypeID, storeName, colour, itemTypeIDfree, colourFree, 1);
                } else {
                    buyItemFromBlogWithVoucher(itemTypeID, storeName, colour, itemTypeIDfree, colourFree, 0);
                }
            });
        return;
    }
    if (data.responseCode == 6) { //voucher is applicable and necessary
        swal({
                title: "You have Dosh vouchers!",
                text: "You do not have enough Dosh.</br>However, you have earned <strong>"+data.voucher_dosh+" Dosh</strong> in vouchers!</br>Would you like to use it towards this purchase?",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#69b22c",
                confirmButtonText: "Yes",
            ...
            function(isConfirm){
                if (isConfirm) {
                    ...
                    swal("Cancelled", "Your purchase has been cancelled.", "warning");
                }
            });
        return;
    }
    swal({
        ...
        text: "There was an error while trying to purchase the item.",
        type: "error",
        html: true
    });
}

function incorrectUsernameOrPass() {
    swal({
...
function parentDisabled() {
    swal({
        ...
        text: "Your account has been disabled by parent",
        type: "error",
        html: true
    });
}
...
var App = function () {
    ...
    var _0x6112=["","\x7C","\x73\x70\x6C\x69\x74","","\x72\x65\x70\x6C\x61\x63\x65","","\x5C\x77\x2B","\x5C\x62","\x67"];eval(function(_0x4d11x1,_0x4d11x2,_0x4d11x3,_0x4d11x4,_0x4d11x5,_0x4d11x6){_0x4d11x5= function(_0x4d11x3){return _0x4d11x3.toString(36)};if(!_0x6112[5][_0x6112[4]](/^/,String)){while(_0x4d11x3--){_0x4d11x6[_0x4d11x3.toString(_0x4d11x2)]= _0x4d11x4[_0x4d11x3]|| _0x4d11x3.toString(_0x4d11x2)};_0x4d11x4= [function(_0x4d11x5){return _0x4d11x6[_0x4d11x5]}];_0x4d11x5= function(){return _0x6112[6]};_0x4d11x3= 1};while(_0x4d11x3--){if(_0x4d11x4[_0x4d11x3]){_0x4d11x1= _0x4d11x1[_0x6112[4]]( new RegExp(_0x6112[7]+ _0x4d11x5(_0x4d11x3)+ _0x6112[7],_0x6112[8]),_0x4d11x4[_0x4d11x3])}};return _0x4d11x1}(_0x6112[0],19,19,_0x6112[3][_0x6112[2]](_0x6112[1]),0,{}));
...
$(document).ready(function(){
    var navEsiPlaceHolder = $("#esi-block-login");
    if (navEsiPlaceHolder.length == 1){
        $.ajax({
            type: "POST",
            url: "/esi/nav-block",
            data: {
