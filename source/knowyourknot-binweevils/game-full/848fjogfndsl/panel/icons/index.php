    ...
    <div class=" container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="https://play.bwrewritten.com/474dnru4394jrfyre/"><img src="../assets/images/logo.png?nocache=<?php echo time(); ?>" alt="logo" style="height:auto;" /></a>
          <a class="sidebar-brand brand-logo-mini" href="https://play.bwrewritten.com/474dnru4394jrfyre/"><img src="../assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
        <ul class="nav">
          <li class="nav-item profile">
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="https://play.bwrewritten.com/474dnru4394jrfyre/panel">
            ...
            <li class="nav-item menu-items">
                ...
                <div class="collapse" id="auth">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item"> <a class="nav-link" id="adm-rewarding" style="cursor: pointer;">Rewarding</a></li>
                    </ul>
                </div>
            </li>
        </ul>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <!--<nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="https://play.bwrewritten.com/474dnru4394jrfyre/"><img src="../assets/images/logo-mini.svg" alt="logo" /></a>
          </div>
            ...
            <ul class="navbar-nav w-100">
              <li class="nav-item w-100">
                <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
                  <input type="text" class="form-control" placeholder="Search weevil" disabled>
                </form>
              </li>
            </ul>
            <ul class="navbar-nav navbar-nav-right" disabled>
              ...
              <li class="nav-item dropdown" disabled>
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name"><?php echo $_SESSION['adm_name'];?></p>
                    <i class="mdi mdi-menu-down d-none d-sm-block"></i>
                  </div>
                </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown" disabled>
