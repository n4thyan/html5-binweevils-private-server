package com.binweevils.overlayUIs.gardenItemControl
{
   ...
   public class SeedGroupData extends EventDispatcher implements IItemData
   {
      ...
      private var _growTime:Number;
      
      private var _id:Number;
      
      private var _ids:Array;
      
      private var _mulch:Number;
      ...
      private var _deliveryTime:Number = 0;
      
      private var _groupable:Boolean = true;
      
      private var _powerConsumption:Number = 0;
      
      private var _type:String;
      
      private var _subType:String;
      
      public function SeedGroupData(param1:Object)
      {
         var _loc2_:int = 0;
         super();
         this._category = param1.cat;
         this._count = param1.count;
         this._cycleTime = param1.cycleTime;
         this._fName = param1.fName;
         this._growTime = param1.growTime;
         ...
         this._mulch = param1.mulch;
         this._name = param1.name;
         this._r = param1.r;
         this._xp = param1.xp;
         this._x = param1.x;
         this._z = param1.z;
         this._age = param1.age;
         this._type = "plant";
      }
