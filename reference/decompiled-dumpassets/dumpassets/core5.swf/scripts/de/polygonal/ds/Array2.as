package de.polygonal.ds
{
   public class Array2 implements Collection
   {
      ...
      public function set(param1:int, param2:int, param3:Number) : void
      {
      ...
      public function resize(param1:int, param2:int) : void
      {
         ...
         var _loc4_:int = param1 < this._w ? param1 : this._w;
         var _loc5_:int = param2 < this._h ? param2 : this._h;
         _loc7_ = 0;
         while(_loc7_ < _loc5_)
         {
      ...
      public function dump() : String
      {
         ...
         while(_loc4_ < this._h)
         {
            ...
            while(_loc5_ < this._w)
            {
               ...
               _loc1_ += "[" + (_loc3_ != undefined ? _loc3_ : "?") + "]";
               _loc5_++;
            }
            _loc4_++;
         }
      ...
      public function dumpLinear() : String
      {
         var _loc1_:String = this._a[0];
         var _loc2_:int = 1;
         while(_loc2_ < this._a.length)
         {
            _loc1_ += "," + this._a[_loc2_];
            _loc2_++;
         }
         return _loc1_;
      }
