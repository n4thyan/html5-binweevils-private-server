package it.gotoandplay.smartfoxserver
{
   ...
   public class SmartFoxClient extends EventDispatcher
   {
      ...
      public function createRoom(param1:Object, param2:int = -1) : void
      {
         ...
         var _loc8_:* = "<room tmp=\'1\' gam=\'" + _loc4_ + "\' spec=\'" + _loc7_ + "\' exit=\'" + _loc5_ + "\'>";
         _loc8_ = _loc8_ + ("<name><![CDATA[" + (param1.name == null ? "" : param1.name) + "]]></name>");
         _loc8_ = _loc8_ + ("<pwd><![CDATA[" + (param1.password == null ? "" : param1.password) + "]]></pwd>");
         _loc8_ = _loc8_ + ("<max>" + _loc6_ + "</max>");
         ...
         {
            _loc8_ += "<xt n=\'" + param1.extension.name;
            _loc8_ = _loc8_ + ("\' s=\'" + param1.extension.script + "\' />");
         }
         if(param1.vars == null)
         {
            _loc8_ += "<vars></vars>";
         ...
         else
         {
            ...
            {
               _loc8_ += this.getXmlRoomVariable(param1.vars[_loc9_]);
            }
            _loc8_ += "</vars>";
         }
         _loc8_ += "</room>";
         this.send(_loc3_,"createRoom",param2,_loc8_);
      }
      ...
      public function joinRoom(param1:*, param2:String = "", param3:Boolean = false, param4:Boolean = false, param5:int = -1) : void
      {
         ...
         if(!this.changingRoom)
         {
            ...
            if(_loc6_ != -1)
            {
               _loc9_ = {"t":"sys"};
               _loc10_ = param4 ? "0" : "1";
               _loc11_ = param5 > -1 ? param5 : this.activeRoomId;
      ...
      public function syncBuddy(param1:String) : void
      {
         ...
         this.send(_loc2_,"syncB",-1,_loc3_);
      }
      ...
      public function setUserVariables(param1:Object, param2:int = -1) : void
      {
         ...
         var _loc3_:Object = {"t":"sys"};
         var _loc4_:Room = this.getActiveRoom();
         if(_loc4_ != null)
         {
            _loc5_ = _loc4_.getUser(this.myUserId);
            if(_loc5_ != null)
            {
               _loc5_.setVariables(param1);
               _loc6_ = this.getXmlUserVariable(param1);
      ...
      {
         var _loc5_:String = this.makeXmlHeader(param1);
         _loc5_ = _loc5_ + ("<body action=\'" + param2 + "\' r=\'" + param3 + "\'>" + param4 + "</body>" + this.closeHeader());
      ...
      private function xmlReceived(param1:String) : void
      {
         ...
         var _loc6_:IMessageHandler = this.messageHandlers[_loc3_];
         if(_loc6_ != null)
         {
      ...
      private function jsonReceived(param1:String) : void
      {
         ...
         var _loc3_:String = _loc2_["t"];
         var _loc4_:IMessageHandler = this.messageHandlers[_loc3_];
         if(_loc4_ != null)
         {
      ...
      private function tryBlueBoxConnection(param1:ErrorEvent) : void
      {
         ...
         if(!this.connected)
         {
            if(this.smartConnect)
            {
               ...
               _loc3_ = this.blueBoxPort != 0 ? int(this.blueBoxPort) : this.httpPort;
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:int = int(this.socketConnection.bytesAvailable);
         while(--_loc2_ >= 0)
         {
