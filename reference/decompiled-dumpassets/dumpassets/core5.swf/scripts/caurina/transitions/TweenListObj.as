package caurina.transitions
{
   public class TweenListObj
   {
      ...
      public function clone(param1:Boolean) : TweenListObj
      {
         ...
         var _loc2_:TweenListObj = new TweenListObj(this.scope,this.timeStart,this.timeComplete,this.useFrames,this.transition,this.transitionParams);
      ...
      public function toString() : String
      {
         var _loc3_:String = null;
         var _loc1_:* = "\n[TweenListObj ";
         _loc1_ += "scope:" + String(this.scope);
         _loc1_ += ", properties:";
         ...
         for(_loc3_ in this.properties)
         {
            ...
            _loc1_ += "[name:" + this.properties[_loc3_].name;
            _loc1_ += ",valueStart:" + this.properties[_loc3_].valueStart;
            _loc1_ += ",valueComplete:" + this.properties[_loc3_].valueComplete;
            _loc1_ += "]";
            _loc2_ = false;
         }
         _loc1_ += ", timeStart:" + String(this.timeStart);
         _loc1_ += ", timeComplete:" + String(this.timeComplete);
         _loc1_ += ", useFrames:" + String(this.useFrames);
         _loc1_ += ", transition:" + String(this.transition);
         _loc1_ += ", transitionParams:" + String(this.transitionParams);
         if(this.skipUpdates)
         {
            _loc1_ += ", skipUpdates:" + String(this.skipUpdates);
         }
         if(this.updatesSkipped)
         {
            _loc1_ += ", updatesSkipped:" + String(this.updatesSkipped);
         }
         if(Boolean(this.onStart))
         {
            _loc1_ += ", onStart:" + String(this.onStart);
         }
         if(Boolean(this.onUpdate))
         {
            _loc1_ += ", onUpdate:" + String(this.onUpdate);
         }
         if(Boolean(this.onComplete))
         {
            _loc1_ += ", onComplete:" + String(this.onComplete);
         }
         if(Boolean(this.onOverwrite))
         {
            _loc1_ += ", onOverwrite:" + String(this.onOverwrite);
         }
         if(Boolean(this.onError))
         {
            _loc1_ += ", onError:" + String(this.onError);
         }
         if(this.onStartParams)
         {
            _loc1_ += ", onStartParams:" + String(this.onStartParams);
         }
         if(this.onUpdateParams)
         {
            _loc1_ += ", onUpdateParams:" + String(this.onUpdateParams);
         }
         if(this.onCompleteParams)
         {
            _loc1_ += ", onCompleteParams:" + String(this.onCompleteParams);
         }
         if(this.onOverwriteParams)
         {
            _loc1_ += ", onOverwriteParams:" + String(this.onOverwriteParams);
         }
         if(this.onStartScope)
         {
            _loc1_ += ", onStartScope:" + String(this.onStartScope);
         }
         if(this.onUpdateScope)
         {
            _loc1_ += ", onUpdateScope:" + String(this.onUpdateScope);
         }
         if(this.onCompleteScope)
         {
            _loc1_ += ", onCompleteScope:" + String(this.onCompleteScope);
         }
         if(this.onOverwriteScope)
         {
            _loc1_ += ", onOverwriteScope:" + String(this.onOverwriteScope);
         }
         if(this.onErrorScope)
         {
            _loc1_ += ", onErrorScope:" + String(this.onErrorScope);
         }
         if(this.rounded)
         {
            _loc1_ += ", rounded:" + String(this.rounded);
         }
         if(this.isPaused)
         {
            _loc1_ += ", isPaused:" + String(this.isPaused);
         }
         if(this.timePaused)
         {
            _loc1_ += ", timePaused:" + String(this.timePaused);
         }
         if(this.isCaller)
         {
            _loc1_ += ", isCaller:" + String(this.isCaller);
         }
         if(this.count)
         {
            _loc1_ += ", count:" + String(this.count);
         }
         if(this.timesCalled)
         {
            _loc1_ += ", timesCalled:" + String(this.timesCalled);
         }
         if(this.waitFrames)
         {
            _loc1_ += ", waitFrames:" + String(this.waitFrames);
         }
         if(this.hasStarted)
         {
            _loc1_ += ", hasStarted:" + String(this.hasStarted);
         }
         return _loc1_ + "]\n";
      }
   }
